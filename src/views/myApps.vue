<template>
  ...
  background-image: url(/src/assets/libr2.jpg); 
  background: cover;
...
.done {
  ...
  text-decoration-color: #996633; /* Deep gold for completed tasks */
}

input[type="text"]::placeholder {
  color: #996633; /* Deep gold for placeholder text */
}
...
.sesi2 li {
  ...
  align-items: center;
  padding: 15px;
  border-bottom: 1px solid #e0d6d0; /* Light grayish border */
...
.checkbox-wrapper svg {
  fill: none;
  stroke: #c7a586; /* Copper for checkbox outline */
  stroke-width: 2px;
  transition: ease all 0.2s;
}

.checkbox-wrapper circle.background {
  fill: #fff; /* White background for checkbox */
  transition: ease all 0.2s;
}

.checkbox-wrapper input[type="checkbox"]:checked + svg .background {
  fill: #ffc107; /* Gold for checked checkbox background */
}
